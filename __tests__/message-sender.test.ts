...
describe('getMonthCelebrants', () => {
  it('should return empty arrays when no family members are provided', async () => {
    const familyMembers: FamilyMember[] = [];
    const { birthdays, anniversaries } = await getMonthCelebrants(familyMembers);

    expect(birthdays).toEqual([]);
    expect(anniversaries).toEqual([]);
  });

  it('should return empty arrays when family members have no valid dates', async () => {
    const familyMembers: FamilyMember[] = [
  ...
  it('should return birthdays for the current month', async () => {
  ...
  it('should return anniversaries for the current month', async () => {
    const today = new Date();
    const currentMonth = today.getMonth();
  ...
  it('should return both birthdays and anniversaries for the current month', async () => {
    const today = new Date();
    const currentMonth = today.getMonth();
  ...
  it('should exclude birthdays and anniversaries outside the current month', async () => {
    const today = new Date();
    const currentMonth = today.getMonth();
...
describe('getTodayCelebrants', () => {
  it('should return empty arrays when no family members are provided', async () => {
    const familyMembers: FamilyMember[] = [];
    const { birthdays, anniversaries } = await getTodayCelebrants(familyMembers);
